...
view(srr285_primary_impact)
write.csv(srr285_primary_impact, file = "srr285_variants.csv", row.names = F)
...
view(srr345_primary_impact)
write.csv(srr345_primary_impact, file = "srr345_variants.csv", row.names = F)
...
view(srr354_primary_impact)
write.csv(srr354_primary_impact, file = "srr354_variants.csv", row.names = F)
...
view(srr358_primary_impact)
write.csv(srr358_primary_impact, file = "srr358_variants.csv", row.names = F)
#===============================================================================
